...
class Fusion(nn.Module):
    def __init__(self, num_class, num_views, hidden_dim, dropout, in_dim):
        super().__init__()
        self.gat1 = GAT(dropout=0.2, alpha=0.5, dim=1000)
        self.gat2 = GAT(dropout=0.2, alpha=0.5, dim=1000)
        self.gat3 = GAT(dropout=0.2, alpha=0.5, dim=503)
        #
